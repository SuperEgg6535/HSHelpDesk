...
function filterTickets(subject) {
    ...
    tickets.forEach(ticket => {
        // Show all subjects and check if status is 'Open'
        if (ticket.status === 'Open' && (subject === 'All' || ticket.subject === subject)) {
...
function filtersTickets(status) {
    ...
    tickets.forEach(ticket => {
        // Show only tickets that are Open
